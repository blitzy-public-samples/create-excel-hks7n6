...
class FileStorageService:
    ...
    def upload_file(self, file_content: bytes, file_name: str) -> str:
        ...
        # SECURITY: no public ACL is set - every uploaded object was world-readable
        # by a permanent URL; access is now a time-limited signed URL
        return blob.generate_signed_url(
            version="v4",
            method="GET",
            expiration=timedelta(minutes=get_settings().signed_url_expiry_minutes),
        )
