...
class FileStorageService:
    ...
    def __init__(self):
        ...
        # Manager reads, so both values it supplies are read once and retained here.
    ...
    def upload_file(self, file_content: bytes, file_name: str) -> str:
        ...
        try:
            # SECURITY: return a time-limited signed URL bound to the uploaded generation;
            # uploaded objects are not made public.
